  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-burgundy to-burgundy-light text-burgundy-foreground shadow-lg hover:shadow-xl hover:scale-105 font-semibold tracking-wide",
        golden: "bg-golden text-golden-foreground shadow-md hover:bg-golden-light hover:shadow-lg font-semibold",
        whatsapp: "bg-[oklch(0.55_0.17_145)] text-[oklch(0.98_0.01_145)] shadow-lg hover:shadow-xl hover:scale-105 font-semibold",
      },
      size: {
